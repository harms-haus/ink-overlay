...
| ---------- | ----------- | ------- | ------------------------------------------------------------------------------------------------ |
| `children` | `ReactNode` | —       | The app tree. Overlay layers render as siblings _after_ `children`, so they always paint on top. |
